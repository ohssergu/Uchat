		...
		<div class="collapse navbar-collapse"
			...
			<ul class="nav navbar-nav navbar-right">
				...
				<ul class="dropdown-menu">
						...
						<li class="active"><a href="profileUpdate.jsp">프로필 수정</a>
				...
				<tbody>
					...
					<tr>
						<td style="width: 110px;"><h5>글 내용</h5></td>
												<td>
						<textarea class="form-control" rows="10" name="boardContent" id="editor" maxlength="2048" placeholder="글 내용을 입력하세요."><%= board.getBoardContent() %></textarea>
						    <script>
