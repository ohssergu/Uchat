		...
		<div class="collapse navbar-collapse"
			...
			<ul class="nav navbar-nav navbar-right">
				...
				<ul class="dropdown-menu">
						<li class="active"><a href="update.jsp">회원정보수정</a>
			...
			<table class="table table-bordered table-hover" style="text-align: center; border: 1px solid #dddddd">
				...
				<tbody>
					...
					<tr>
						...
						<td colspan="2"><input class="form-control" type="text" id="userPhone" name="userPhone" maxlength="20" placeholder="폰 번호를 입력하세요." value="<%= user.getUserPhone() %>"></td>
					</tr>
					<tr>
						<td style="width: 110px;"><h5>회원탈퇴</h5></td>
						<td colspan="2"><input class="btn btn-primary" value="회원 탈퇴하기" onClick="location.href='userDelete?userID=<%=user.getUserID() %>'"></td>
					</tr>
					<tr>
